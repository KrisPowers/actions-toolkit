  ...
  return (
    <div className="flex h-full flex-col">
      <div className="pb-3">
        <PageHeader
          title="Logs"
          subtitle="Live console for a run, without leaving the repo."
          actions={
            <>
              ...
              {runId && (
                <Link to={`/runs/${runId}`} className="inline-flex items-center gap-1 text-xs text-accent hover:underline">
                  Full run
